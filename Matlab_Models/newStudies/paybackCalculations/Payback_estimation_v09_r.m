...
battery_cap_nominates   = 10; %linspace(0,30,301);                     % Different battery capacity with the step of 0.1
pv_cap_nominates        = 5; %[2,3,4,5,6,7,8,9,10];  %linspace(1,10,10);
...
subplot(4,1,4);
plot(battery_charge_capacity,"Color",'magenta', 'HandleVisibility','off'); %,'DisplayName', "BESS available energy amount"
...
%legend show;
exportgraphics(f,'graph_5.jpg','Resolution',600);
toc;
