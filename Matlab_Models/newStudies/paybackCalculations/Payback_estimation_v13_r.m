...
Inv_PriceB              = 600; %950;                 % Investment cost of battery ($/kWh).
...
for pv_size = pv_cap_nominates
    ...
    %pv_generated_energy = pv_generated_energy*0.01;
...
legend show;
ax = gca;
% exportgraphics(ax,'new.jpg','Resolution',400)
hold off;
...
%xlim([0 70]);
ax2 = gca;
% exportgraphics(ax2,'new2.jpg','Resolution',400)
hold off;
