% Simple scheduling
% Calculations for various pv and battery sizes and comparison of payback time and inv.profit during 20 years.
% In this version the real price data is used.
% in this version (11) system will run for 20 years.
clc
clear
close all;
tic;
...
inv.essPv               = zeros((simu.hardwareSamples));               % investement on infrastructuBESres                                                  
...
for Enr_size = ess.enR_max
    ...
    for pv_size = pv.nominates
        ...
        for ess_size = ess.nominates
            ...
            % End of x years simulation for each combination of PV_BES_ER
            % system data logging
